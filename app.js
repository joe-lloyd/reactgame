...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		if (document.querySelector('.game')) {
			_reactDom2.default.render(_react2.default.createElement(_app2.default, null), document.querySelector('.game'));
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactGameKit = __webpack_require__(300);
	
	var _react = __webpack_require__(303);
	
	var _react2 = _interopRequireDefault(_react);
	
	var _game = __webpack_require__(370);
	  ...
	  */
		...
		_createClass(App, [{
			...
			value: function componentDidMount() {
				this.keyListener.subscribe([this.keyListener.LEFT, this.keyListener.RIGHT, this.keyListener.UP, this.keyListener.SPACE]);
			}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						_reactGameKit.Stage,
						null,
						_react2.default.createElement(_game2.default, { keys: this.keyListener })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _audioPlayer = __webpack_require__(301);
	
	var _audioPlayer2 = _interopRequireDefault(_audioPlayer);
	
	var _body = __webpack_require__(302);
	
	var _body2 = _interopRequireDefault(_body);
	
	var _loop = __webpack_require__(363);
	
	var _loop2 = _interopRequireDefault(_loop);
	
	var _keyListener = __webpack_require__(365);
	...
	var _stage = __webpack_require__(367);
	
	var _stage2 = _interopRequireDefault(_stage);
	
	var _tileMap = __webpack_require__(368);
	
	var _tileMap2 = _interopRequireDefault(_tileMap);
	
	var _world = __webpack_require__(369);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Matter.Body = __webpack_require__(334);
	Matter.Composite = __webpack_require__(341);
	Matter.World = __webpack_require__(349);
	
	Matter.Contact = __webpack_require__(345);
	Matter.Detector = __webpack_require__(346);
	Matter.Grid = __webpack_require__(343);
	Matter.Pairs = __webpack_require__(351);
	Matter.Pair = __webpack_require__(344);
	Matter.Query = __webpack_require__(352);
	Matter.Resolver = __webpack_require__(354);
	Matter.SAT = __webpack_require__(347);
	
	Matter.Constraint = __webpack_require__(350);
	Matter.MouseConstraint = __webpack_require__(355);
	
	Matter.Common = __webpack_require__(337);
	Matter.Engine = __webpack_require__(357);
	Matter.Events = __webpack_require__(339);
	Matter.Mouse = __webpack_require__(356);
	Matter.Runner = __webpack_require__(359);
	Matter.Sleeping = __webpack_require__(338);
	
	// @if DEBUG
	Matter.Metrics = __webpack_require__(358);
	// @endif
	
	Matter.Bodies = __webpack_require__(353);
	Matter.Composites = __webpack_require__(360);
	
	Matter.Axes = __webpack_require__(348);
	Matter.Bounds = __webpack_require__(342);
	Matter.Svg = __webpack_require__(361);
	Matter.Vector = __webpack_require__(336);
	Matter.Vertices = __webpack_require__(335);
	
	Matter.Render = __webpack_require__(340);
	Matter.RenderPixi = __webpack_require__(362);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Vertices = __webpack_require__(335);
	var Vector = __webpack_require__(336);
	var Sleeping = __webpack_require__(338);
	var Render = __webpack_require__(340);
	var Common = __webpack_require__(337);
	var Bounds = __webpack_require__(342);
	var Axes = __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Common = __webpack_require__(337);
	var Composite = __webpack_require__(341);
	var Bounds = __webpack_require__(342);
	var Events = __webpack_require__(339);
	var Grid = __webpack_require__(343);
	var Vector = __webpack_require__(336);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Events = __webpack_require__(339);
	var Common = __webpack_require__(337);
	var Body = __webpack_require__(334);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Pair = __webpack_require__(344);
	var Detector = __webpack_require__(346);
	var Common = __webpack_require__(337);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Contact = __webpack_require__(345);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var SAT = __webpack_require__(347);
	var Pair = __webpack_require__(344);
	var Bounds = __webpack_require__(342);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Composite = __webpack_require__(341);
	var Constraint = __webpack_require__(350);
	var Common = __webpack_require__(337);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var SAT = __webpack_require__(347);
	var Bounds = __webpack_require__(342);
	var Bodies = __webpack_require__(353);
	var Vertices = __webpack_require__(335);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Vertices = __webpack_require__(335);
	var Sleeping = __webpack_require__(338);
	var Mouse = __webpack_require__(356);
	var Events = __webpack_require__(339);
	var Detector = __webpack_require__(346);
	var Constraint = __webpack_require__(350);
	var Composite = __webpack_require__(341);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var World = __webpack_require__(349);
	var Sleeping = __webpack_require__(338);
	var Resolver = __webpack_require__(354);
	var Render = __webpack_require__(340);
	var Pairs = __webpack_require__(351);
	var Metrics = __webpack_require__(358);
	var Grid = __webpack_require__(343);
	var Events = __webpack_require__(339);
	var Composite = __webpack_require__(341);
	var Constraint = __webpack_require__(350);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Events = __webpack_require__(339);
	var Engine = __webpack_require__(357);
	var Common = __webpack_require__(337);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameLoop = __webpack_require__(364);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sprite = (_temp = _class = function (_Component) {
	  ...
	  _createClass(Sprite, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('div', { style: _extends({}, this.getWrapperStyles(), this.props.style) }, _react2.default.createElement('img', {
	...
	var Stage = (_temp = _class = function (_Component) {
	  ...
	  _createClass(Stage, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { style: this.getWrapperStyles(), ref: function ref(c) {
	          _this2.container = c;
	        } }, _react2.default.createElement('div', { style: _extends({}, this.getInnerStyles(), this.props.style) }, this.props.children));
	    }
	  }]);
	...
	var TileMap = (_temp = _class = function (_Component) {
	  ...
	  _createClass(TileMap, [{
	      ...
	      layers.forEach(function (l, index) {
	        ...
	        for (var r = 0; r < rows; r++) {
	          for (var c = 0; c < columns; c++) {
	            ...
	            if (l[gridIndex] !== 0) {
	              layer.push(_react2.default.createElement('div', {
	                key: 'tile-' + index + '-' + r + '-' + c,
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { style: _extends({}, this.getWrapperStyles(), this.props.style) }, layers.map(function (layer, index) {
	        return _react2.default.createElement('div', { key: 'layer-' + index, style: _this3.getLayerStyles() }, layer);
	      }));
	    }
	  }]);
	...
	var World = (_temp = _class = function (_Component) {
	  ...
	  _createClass(World, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('div', { style: defaultStyles }, this.props.children);
	    }
	  }]);
	...
	var Game = function (_Component) {
		...
		function Game(props) {
			...
			_this.checkKeys = function () {
				...
				if (keys.isDown(keys.SPACE)) {
					_this.setState({ facing: 0 });
				}
				if (keys.isDown(keys.LEFT)) {
					_this.setState({ facing: 2 });
				}
				if (keys.isDown(keys.RIGHT)) {
					_this.setState({ facing: 1 });
				}
				if (keys.isDown(keys.UP)) {
					_this.setState({ facing: 3 });
				}
			};
	  ...
	  */
	   ...
	   */
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement(_reactGameKit.Sprite, { repeat: true,
					scale: 0.4,
					offset: [0, 10],
